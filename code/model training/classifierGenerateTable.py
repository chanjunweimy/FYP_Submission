...
from classifierWithFS import getClassifiers, getClassifiersWithoutFS, getAllFeatures, getMeanFeatures, preLoadData, selectFeatures, testPerformance, getTestFeatures
...
def automaticChooseFeatures(hasFs, maxFeature, featureChoices, i, X_train, X_dev, y_bin_train, y_bin_dev):
	...
	if i == len(featureChoices):
		X_train2, X_dev2, chosenFeatures, numOfFeatures = selectFeatures(maxFeature, featureChoices, X_train, X_dev)
...
def main():
	...
	chosenFeatureAndModels = automaticChooseFeatures(True, maxFeature, featureChoices, 0, X_train, X_dev, y_bin_train, y_bin_dev)
